...
{
  // :: use the nested type to reduce instanciations ????
...
template<> struct gemv_selector<OnTheRight,ColMajor,false>
{
  ...
  {
    typedef typename Dest::Index Index;
    // :: makes sure dest is sequentially stored in memory, otherwise use a temp
...
template<> struct gemv_selector<OnTheRight,RowMajor,false>
{
  ...
  {
    typedef typename Dest::Index Index;
    // :: makes sure rhs is sequentially stored in memory, otherwise use a temp
